...
<!-- saved from url=(0036)http://ljean.com/files/what2ask.html -->
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<title>L Jean Camp</title>

<link href="http://www.ljean.com/sub.css" type="text/css" rel="stylesheet">
</head>
<body>
    <div id="container">
        <div id="title"></div>
...
<a class="nav" href="http://www.ljean.com/index.html">Home</a>&nbsp;&nbsp;&nbsp;        <?php include('http://www.ljean.com/navLinks.html');?>
        

     <br><br><p>&nbsp;</p>
    <p>&nbsp;</p>
    <div class="content">
    <br> <strong><a name="top"></a>Stuff Your Mentor Will Tell You</strong>
<br>
<br>
...
<ul>
<li>CRA has jobs <a href="http://www.cra.org/ads/">http://www.cra.org/ads/</a>
...
</li><li><em>Evaluation or tenure</em> for joint appointments who does annual reviews? Will you have assigned mentors in both departments (shared, adjunct, or courtesy)?
</li><li><em>Tenure standards</em> documents and processes, and statistics. Have they ever tenured a person of your type?
</li><li><em>Starting date</em> is amazingly negotiable. We understand, we had dissertations to finish.
</li><li><em>Start-up</em> ask what has been given in the past. If you know people who graduated 2-3 years before you, ask them. 
</li><li><em>Living expenses</em> moving cost, housing allowances. Usually moving requires three quotes from three movers, but sometimes there is a cap.  Even if the secretary is clueless, get three quotes. 
</li><li><em>Benefits</em> What are they and what percentage is paid by the university?
</li><li><em>Retirement Benefits</em> Under what conditions does the University contribute (e.g., matching, vested, etc.)? When are you vested?
</li><li><em>Leaves</em> Fulbrights, sabaticals, invited leaves, pre-tenure research leaves. 
</li><li><em>Tuition benefits for family</em> for those with or planning kids.
</li><li><em>Travel budget</em> and travel policies for when that budget runs out.
</li><li><em>Two body problem help</em> as needed, but this may also be an indicator of culture.
</li><li><em>Facilities &amp; space</em> if you do not ask for it during the negotiation stage you will never get it. The answer will also indicate if the place is well-managed. Are there clear ways to ensure space?  Do all doctoral students automatically have space? Are there lab space policies or is it based entirely on whims of chairs and deans?
</li><li><em>Computers</em> and updates on the computers - after the first do you have to raise your own money?
</li><li><em>Office furniture</em> yep, some places take it out of start-up.
</li><li><em>Staff support</em> you can only get theory on this but the theory is an important starting place.
</li><li><em>Salary options</em> twelve month payments for ten months need to start immediately.
</li><li><em>Admitting doctoral students</em> is critical. If you cannot admit doctoral students, your research is at risk. Can you admit a selected student? 
    </em>
    <ul>
...
<ul>
    <li> What support is in the unit? The larger organizational units?  How about the city and state?</li>
    <li> Is the unit integrated with the local entrepreneurial community? How? Can you access that network?</li>
    <li> How is the intellectual property office in terms of responsiveness and support?  (For this you must ask other faculty, the Dean will say it is just wonderful.)</li>
...
<li><em>Two body problem help</em> again ask as needed, but this may also be an indicator of culture.</li>
...
</li><li><a href="http://www.cs.wm.edu/~srgian/tier-conf-final2007.html">http://www.cs.wm.edu/~srgian/tier-conf-final2007.html</a>
</li><li><a href="http://webdocs.cs.ualberta.ca/~zaiane/htmldocs/ConfRanking.html">http://webdocs.cs.ualberta.ca/~zaiane/htmldocs/ConfRanking.html</a>
</li></ul>
<br><br>

This is a nice blog post that has some recommendations on how to prepare a package. I particularly like the cover letter recommendations: <a href="http://mommyscientist.blogspot.com/2006/08/faculty-packages.html">http://mommyscientist.blogspot.com/2006/08/faculty-packages.html</a>
<br><br>
Also for scientists,with a focus on negotiating salary <a href="http://sciencecareers.sciencemag.org/career_development/previous_issues/articles/2006_06_16/tooling_up_salary_negotiation_part_1">http://sciencecareers.sciencemag.org/career_development/previous_issues/articles/2006_06_16/tooling_up_salary_negotiation_part_1</a>. (it wasn't my naming scheme, blame me not.)
<br><br>

    <strong>Congrats! You Got Tenure. How to Write a Promotion Letter</strong>
<br><br>
    ...
    <ol>
        <li>  State your recommendation up front.</li>
        <li>  Introduce yourself, and identify area overlap and differences in terms of reasearch areas.</li>
        <li>  Put in a general paragraph about interaction with candidate, identify any Conflict of Interest.</li>
        <li>  You get three papers. For each paper, one paragraph includes a two sentence description of the work, a sentence or so about how it fits in the body of knowledge. What is unique? Define its contributions.  </li>
        <li>  Repeat for paper 2 in one paragraph.</li>
        <li>  Repeat for paper 3 in one paragraph.</li>
        <li>  Unless you have particular insight, something polite about why do we ask people from outside the institution to talk about this person's teaching? This remains a mystery to me.</li>
        <li> What is the person's overall impact? You may include your thoughts about impact trajectory particularly if you are requested to do so in the letter from the Dean or Chair. Venues of publication, participation in the community, and funding may be discussed  here as appropriate for research area.</li>
        <li> Repeat recommendation in closing.</li>
    </ol>
    <br><br>
</div>
